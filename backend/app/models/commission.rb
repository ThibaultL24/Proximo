...
class Commission < ApplicationRecord
  ...
  validate :platform_fee_cannot_exceed_amount
  ...
  def platform_fee_cannot_exceed_amount
    return if platform_fee_cents.blank? || amount_cents.blank?
    return if platform_fee_cents <= amount_cents

    errors.add(:platform_fee_cents, "ne peut pas depasser le montant total")
  end
end
